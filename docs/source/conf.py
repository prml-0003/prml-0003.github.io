...
Basic
'''
project = '&nbsp; <span style="vertical-align: super; padding-top: 0; padding-bottom: 20px">Emissions</span>'
...
html_theme_options = {
    'canonical_url': 'https://prml-0003.github.io/',
...
html_title = 'CLIMATE & SUSTAINABILITY'
